...
export class Clock {
  ...
  public equals(other: Clock): boolean {
    let reloj:Clock = new Clock(Math.floor((other.minute as number/ 60) % 24), other.minute as number % 60)
    return (Math.floor((this.minute as number/ 60) % 24) == Math.floor((reloj.minute as number/ 60) % 24) && (this.minute as number % 60) == reloj.minute as number % 60) 
  }
}
